...
#define RVA_PROCESS_ANIMATION_MERGES 0x009BC070U // Processes SWF animation merges so named-part bindings can be finalized after append work...
#define RVA_FIND_SWF_EXPORT 0x009BB6F0U // Resolves SWF exports and intercepts annotated/synthetic texture append targets...
#define RVA_APPEND_MOVIE_CLIP 0x00A58440U // Appends one MovieClip into another and records appended frame ranges/source definitions...
#define RVA_FIND_SWF_CHARACTER 0x00A4A190U // Looks up an SWF character definition by character ID...
#define RVA_GON_INDEX_BY_NAME_CONST 0x00942CA0U // Const GON field lookup used to resolve @named cat part references to numeric frames...
#define RVA_GON_INDEX_BY_NAME 0x00942DA0U // Mutable GON field lookup used to resolve @named cat part references to numeric frames...
#define RVA_CAT_PART_GRAPHICS_REFRESH 0x0073A450U // Refreshes CatPartGraphics and synchronizes appended texture frames on first use...
#define RVA_MOVIE_CLIP_SET_FRAME 0x009A88A0U // Sets a MovieClip to a zero based frame after its backing texture definition is synchronized...
