...
def main() -> int:
    parser: argparse.ArgumentParser = argparse.ArgumentParser(description="Update MewCatPartFramework.h RVAs from Mewgenics byte signatures.")
    parser.add_argument("exe_path", type=Path, help="Path to the updated Mewgenics executable.")
    parser.add_argument("header_path", type=Path, help="Path to MewCatPartFramework.h.")
    parser.add_argument("--signatures", type=Path, default=Path(__file__).with_name("mew_cat_part_framework_signatures.json"), help="Path to mew_cat_part_framework_signatures.json.")
